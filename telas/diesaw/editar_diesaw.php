...
$result_usuario = "SELECT * FROM cadastro_diesaw WHERE id = '$id'";
...
<head>
    ...
    <link rel="stylesheet" href="/ccbs/assets/CSSSS/style.css">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>
    ...
    <div class="container">
        ...
        <div class="form">
            <form action="/ccbs/php/diesaw/proc_editblade_diesaw.php" method="POST">
                <div class="form-header">
                    <div class="title">
                        <h2>Edit Blade Life</h2>
                    </div>
                    <div class="login-button">
                        <button><a href="consulta_diesaw.php">Voltar</a></button>
                    </div>
                </div>
                ...
                <div class="continue-button">
                    <button><a href="/ccbs/php/diesaw/proc_editblade_diesaw.php"> Editar </a></button>
                </div> 
            </form>
        </div>
    </div>
