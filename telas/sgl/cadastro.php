...
<body>
    ...
    <div class="container">
        ...
        <div class="form">
            <form action="/ccbs/php/sgl/processa.php" method="POST">
                ...
                <div class="input-group">
                    ...
                    <div class="input-box">
                        ...
                        <input id="tamanho" maxlength="21" type="tam" name="tamanho" placeholder="00mm x 00mm x 0.000mm" required>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        <label for="partnumber">Enter Blade PartNumber</label>
                        <input id="partnumber" maxlength="9" type="pn" name="partnumber" placeholder="Digite a PN da Blade" required>
                    </div>
                    <div class="input-box">
                ...
                <div class="continue-button">
                    <button><a href="/ccbs/php/sgl/processa.php"> Cadastrar </a></button>
                </div>            
            </form>
        </div>
    </div>
